...
/**
 * NOTE: This class was directly copied from Flink's
 * org.apache.flink.formats.utils.DeserializationSchemaMatcher
 *
...
public abstract class DeserializationSchemaMatcher extends TypeSafeMatcher<byte[]> {
    ...
    private static final class DeserializationSchemaResultMatcher extends DeserializationSchemaMatcher {
    ...
    private static final class DeserializationSchemaExceptionMatcher
    ...
    public static final class DeserializationSchemaMatcherBuilder {
